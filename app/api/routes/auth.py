...
@router.get("/verify-email", response_class=FileResponse)
async def verify_email_page():
    return _html("auth/verify_email.html")
...
async def forgot_password_page():
    return _html("auth/forgot_password.html")
...
async def reset_password_page():
    return _html("auth/reset_password.html")
