...
# from app.services.isw_service import ISWError, find_bank_code
...
#     bank_code = find_bank_code(payload.bank_name)
#     if not bank_code:
#         raise HTTPException(status_code=400, detail=f"Bank '{payload.bank_name}' not recognised")

#     # ISW does not expose a public account-name resolution endpoint;
#     # we store the name as provided and mark it verified by bank-code lookup.
